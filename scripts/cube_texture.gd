extends Node2D
@onready var COLOR_1 = GLOBALS.CURRENT_GREEN
@onready var COLOR_2 = GLOBALS.CURRENT_YELLOW
@onready var COLOR_3 = GLOBALS.CURRENT_PURPLE
@onready var COLOR_4 = GLOBALS.CURRENT_RED
@onready var COLOR_5 = GLOBALS.CURRENT_BLUE
@onready var COLOR_6 = GLOBALS.CURRENT_ORANGE
...
func mode_thingy(DIFFICULTY,INVERTED):
	if INVERTED == "true":
		COLOR_1 = GLOBALS.CURRENT_PURPLE
		COLOR_2 = GLOBALS.CURRENT_RED
		COLOR_3 = GLOBALS.CURRENT_GREEN
		COLOR_4 = GLOBALS.CURRENT_YELLOW
		COLOR_5 = GLOBALS.CURRENT_ORANGE
		COLOR_6 = GLOBALS.CURRENT_BLUE
	else:
		COLOR_1 = GLOBALS.CURRENT_GREEN
		COLOR_2 = GLOBALS.CURRENT_YELLOW
		COLOR_3 = GLOBALS.CURRENT_PURPLE
		COLOR_4 = GLOBALS.CURRENT_RED
		COLOR_5 = GLOBALS.CURRENT_BLUE
		COLOR_6 = GLOBALS.CURRENT_ORANGE
...
func _process(_delta):
	if not GAME_DIFFICULTY == "invisible":
		if COLOR_1 != GLOBALS.CURRENT_GREEN \
		or COLOR_2 != GLOBALS.CURRENT_YELLOW \
		or COLOR_3 != GLOBALS.CURRENT_PURPLE \
		or COLOR_4 != GLOBALS.CURRENT_RED \
		or COLOR_5 != GLOBALS.CURRENT_BLUE \
		or COLOR_6 != GLOBALS.CURRENT_ORANGE:
			COLOR_1 = GLOBALS.CURRENT_GREEN
			COLOR_2 = GLOBALS.CURRENT_YELLOW
			COLOR_3 = GLOBALS.CURRENT_PURPLE
			COLOR_4 = GLOBALS.CURRENT_RED
